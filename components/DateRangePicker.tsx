        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-[60] flex items-center justify-center p-4 auth-modal-enter">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xs md:max-w-2xl flex flex-col auth-modal-content-enter">
                ...
                <main className="flex-grow flex justify-center relative">
                    <button onClick={goToPrevMonth} className="absolute left-2 top-1/2 -translate-y-1/2 z-10 p-2 text-slate-600 hover:text-slate-900 rounded-full hover:bg-slate-100">
                    ...
                    <button onClick={goToNextMonth} className="absolute right-2 top-1/2 -translate-y-1/2 z-10 p-2 text-slate-600 hover:text-slate-900 rounded-full hover:bg-slate-100">
