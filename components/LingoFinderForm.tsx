      ...
      <div className="flex-shrink-0 p-4 border-b border-slate-200 bg-white">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-100 text-gray-800 border border-slate-200 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition"
            autoFocus
          />
        </div>
      </div>
