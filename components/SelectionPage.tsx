  ...
  return (
    <div className="fixed inset-0 bg-white z-[60] flex flex-col slide-down-animation">
      ...
      <main className="flex-grow overflow-y-auto">
        {error ? (
        ...
        ) : isLoading && searchValue.trim().length > 1 ? (
          <div className="flex flex-col items-center justify-center p-8 space-y-4">
            ...
            <div className="flex items-center space-x-2 text-slate-600">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 animate-bounce text-violet-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              <span className="font-semibold">Searching for locations</span>
