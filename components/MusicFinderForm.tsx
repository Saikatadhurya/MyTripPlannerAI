  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="text-center mb-6 sm:mb-8 md:mb-10">
        ...
        <p className="mt-2 text-sm sm:text-base md:text-lg text-slate-600">Discover the soundtrack of your travels.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8 bg-white/60 backdrop-blur-md p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-slate-200/70 shadow-xl">
        <div className="relative">
          ...
          <div className="relative">
            ...
            <input id="destination" ref={inputRef} type="text" value={formData.destination} onChange={handleDestinationChange} onBlur={handleDestinationBlur} placeholder="e.g., Havana, Cuba" className="w-full pl-10 pr-4 py-2 bg-white text-sm sm:text-base text-gray-800 border border-slate-300 rounded-lg focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500 transition" required autoComplete="off" />
          </div>
