  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-6 sm:mb-8 md:mb-10">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">Itinerary Planner</h1>
        <p className="mt-2 text-sm sm:text-base md:text-lg text-slate-600">Fill in the details for a personalized day-by-day plan.</p>
      </div>
            ...
            <div className={`grid grid-cols-1 ${showStartPoint ? 'sm:grid-cols-2' : ''} gap-4`}>
               {showStartPoint && (
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1 relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-white text-sm sm:text-base text-gray-800 border border-slate-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition"
                            autoComplete="off"
                            draggable={false}
                          />
                          {stop.isLoading && (
                        ...
                        {apiKeyError && (
                          <div style={{ animation: 'validation-fade-in 0.3s ease' }} className="mt-2 text-sm text-amber-700 bg-amber-100/60 p-2 rounded-md flex items-center space-x-2">
                              ...
                              <span className="flex items-center flex-wrap gap-1">
                                {apiKeyError.includes('API key not valid') ? (
                                  <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="persons" className="block text-xs sm:text-sm font-medium text-slate-700 mb-1">Travelers</label>
