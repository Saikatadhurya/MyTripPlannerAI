...
export const generateMusicRecommendations = async (data: MusicFinderRequestData): Promise<MusicRecommendations> => {
  ...
  while (attempts < maxAttempts) {
      ...
      try {
          ...
          console.error(`Attempt ${attempts}/${maxAttempts} failed to generate and parse music recommendations:`, error);
  ...
  throw new Error("Failed to generate music recommendations after multiple attempts.");
};