...
export const generateItinerary = async (
  ...
  if ((tripType === 'Car' || tripType === 'Bike') && isRoundTrip && startPoint) {
      ...
      1.  **Feasibility & Route Planning**: First, you MUST estimate if a meaningful road trip circuit that includes or goes towards "${destination}" is possible within ${days} days, using a ${tripType} with a daily driving limit of ${dailyLimit}.
          - **IF FEASIBLE**:
              - **A. Pace & Richness (CRITICAL):** Your primary goal is to create a trip that makes full and enjoyable use of the **${days} days** provided. Do NOT rush the itinerary. If the duration is generous for a direct route, you MUST enrich the journey by intelligently adding more relevant destinations and experiences. Create a well-paced, leisurely, and comprehensive tour.
      ...
      1.  **Route & Transport Planning**:
          -   **A. Pace & Richness (CRITICAL):** Your primary goal is to create a trip that makes full and enjoyable use of the **${days} days** provided. Do NOT rush the itinerary. If the duration is generous for a direct route, you MUST enrich the journey by intelligently adding more relevant destinations and experiences. Create a well-paced, leisurely, and comprehensive tour. For example, a 15-day trip allows for more cities and more time in each city than a 5-day trip.
